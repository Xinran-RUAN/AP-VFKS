...
\newblock \doititle{Energy and implicit discretization of the {F}okker--{P}lanck and {K}eller--{S}egel type equations},
...
\newblock \doititle{Entropy dissipation methods for degenerate parabolic problems and generalized {S}obolev inequalities},
...
\newblock \doititle{Kinetic models for chemotaxis and their drift-diffusion limits},
\newblock in \emph{Nonlinear Differential Equation Models, Springer},  (2004), 123-141.

\bibitem{chertock2019high} % incollection
\newblock A. Chertock and A. Kurganov, 
\newblock \doititle{High-resolution positivity and asymptotic preserving numerical methods for chemotaxis and related models},
\newblock in \emph{Active Particles, Volume 2, Springer},  (2019), 109-148. 

\bibitem{dolak2005keller} 
\newblock Y. Dolak and C. Schmeiser,   
\newblock \doititle{The {K}eller--{S}egel model with logistic sensitivity function and small diffusivity},
...
\newblock \doititle{A class of asymptotic-preserving schemes for the {F}okker--{P}lanck--{L}andau equation},
...
\bibitem{murray2002introduction} % book 
\newblock J. D. Murray, 
\newblock \doititle{Mathematical biology: I: An introduction},
\newblock \emph{Springer}, 2002.

\bibitem{murray2003mathematical} % book 
\newblock J. D. Murray, 
\newblock \doititle{Mathematical biology: II: Spatial models and biomedical applications},
\newblock \emph{Springer}, 2003.
